...
describe("RomanNumeralController", () => {
    test("should return correct Roman numeral for valid input", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test("should return 400 for invalid input (zero)", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test("should return 400 for out-of-range input", () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(server_1.default).get("/romannumeral?query=4000");
        expect(response.status).toBe(400);
        expect(response.body).toEqual({
            success: false,
            message: "Invalid query parameter",
